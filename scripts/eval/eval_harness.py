...
class EvalHarnessAdapter(GPT2LM):
    ...
    def __init__(self, model, tokenizer):
        ...
        self.VOCAB_SIZE = gptneox20b.Args20b.vocab_size
        self.model = model
        ...
        self.full_attention_mask = gptneox20b.generate_mask(2048).to(self.device)
...
def main():
    ...
    model = gptneox20b.create_model(args.model_path)
    tokenizer = gptneox20b.create_tokenizer(args.tokenizer_path)
